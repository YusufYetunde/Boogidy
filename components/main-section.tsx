...
const MainSection: NextPage = () => {
  return (
    <main className="self-stretch flex flex-col items-center justify-center md:flex-col md:pt-0 md:pb-0 md:box-border">
      ...
      <section className="w-full overflow-hidden flex flex-col py-16 px-0 box-border items-center justify-center text-center text-13xl text-gray-100 font-inter animate-fade-in md:flex-col md:gap-[8px] md:pt-1 md:pb-1 md:box-border">
        <div className="self-stretch flex flex-col py-2 px-0 items-center justify-center gap-[24px] md:pt-1 md:pb-1 md:box-border">
          <div className="self-stretch relative font-semibold">
            How it works?
            <div className="self-stretch relative text-sm font-thin text-darkslategray">
            <p className="m-0 text-gray-500 pt-2">
              Our app offers simple steps to seamless steps for your
              transportation needs giving you streamlined <br/>and memorable journey
          ...
          <div className="flex-1 flex flex-col items-center justify-center md:flex-[unset] md:self-stretch">
            <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
              ...
              <div className="self-stretch flex flex-col items-center justify-center gap-[16px] text-5xl text-gray-100">
                ...
                <div className="self-stretch relative text-gray-500 text-base leading-[24px]">
      ...
      <section className=" bg-[url(/hero@3x.png)] bg-cover bg-no-repeat opacity- w-full flex flex-col py-12 px-4 box-border items-center justify-center gap-[16px] text-center text-17xl text-white font-inter animate-fade-in md:gap-[8px] md:pt-1 md:pr-0 md:pb-1 md:box-border">
        ...
        <div className="self-stretch flex flex-row py-0 px-2 items-center justify-start gap-[20px] text-5xl text-gray-200 md:flex-col md:gap-[8px] md:items-center md:justify-start">
          <a
            className="[text-decoration:none] flex-1 flex flex-col py-6 px-12 items-center justify-center gap-[8px] text-[inherit]outline-none md:flex-[unset] md:self-stretch"
            href="#"
          >
            <img
          ...
          <a
            className="[text-decoration:none] flex-1 flex flex-col py-6 px-12 items-center justify-center gap-[8px] text-[inherit] border-[1px] border-solid border-white md:flex-[unset] md:self-stretch"
            href="#"
          >
            <img
      ...
      <section className="w-[1140px] overflow-hidden flex flex-row py-16 px-0 box-border items-center justify-start text-left text-5xl text-gray-100 font-inter animate-fade-in md:flex-col md:items-center md:justify-center md:py-1 md:px-0 md:box-border">
      ...
      <section className="w-[1140px] flex flex-col py-6 px-0 box-border items-center justify-center gap-[16px] text-left text-13xl text-gray-200 font-inter animate-fade-in md:flex-col md:gap-[8px] md:pt-1 md:pb-1 md:box-border">
      ...
      <section className="box-border w-[1140px] flex flex-row py-8 px-0 items-center justify-center gap-[16px] text-right text-lg text-black font-inter animate-[fade-in_ border-[1px] border-solid border-dimgray-100 md:flex-col md:gap-[8px] md:items-center md:justify-center md:py-1 md:px-0 md:box-border">
