...
const SignInForm: NextPage = () => {
  return (
    <div className="flex-1 flex flex-col flex-wrap h-auto m-auto items-start justify-center gap-[16px] text-center text-17xl text-gray-100 font-inter md:pl-0.5 md:pr-6 md:box-border md:flex-[unset] md:self-stretch">
      <div className="[text-decoration:none] basic-full max-w-full px-[20px] self-stretch flex flex-row items-center justify-center">
      <img
      ...
      <div className="self-stretch flex flex-col items-center justify-center basic-full max-w-full px-[20px] gap-[8px]">
        ...
        <div className="self-stretch flex flex-col items-center justify-center gap-[8px] text-xs">
          <div className="self-stretch flex flex-col items-center justify-center gap-[8px]">
            <input
              className="font-inter text-sm self-stretch flex flex-row py-4 px-4 items-center justify-start border-[1px] border-solid border-gainsboro"
              type="email"
              placeholder="Email"
              required
            />
            <input
              ...
              required
            />
            <button className="cursor-pointer [border:none] py-4 px-4 bg-crimson self-stretch overflow-hidden flex flex-row items-center justify-start">
              <div className="flex-1 relative text-sm font-semibold font-inter text-white text-center">
                Login
              </div>
            </button>
            <a
              className="[text-decoration:none] self-stretch relative leading-[24px] text-[inherit] text-crimson"
              href="#"
            >
              Forgot Password?
            </a>
        ...
        <div className="self-stretch flex flex-col items-center justify-center gap-[32px] text-sm">
          ...
          >
            <span>{`New User? `}</span>
            <span className="text-crimson hover:underline">Create Account</span>
          </a>
          <a
