...
const AddressCard: NextPage<AddressCardType> = ({ locationText }) => {
  return (
    <div className="w-full rounded-lg bg-white flex flex-col py-4 pl-4 items-center justify-center gap-[10px] text-left text-lg text-darkgray-100 font-inter border-[1px] border-solid border-crimson ">
      <div className="w-full flex flex-row items-center justify-between text-gray-100">
        <div className="relative font-semibold inline-block w-[354px] shrink-0">
          {locationText}
        </div>
        <div className="w-full flex flex-row items-center justify-start pr-4">
      ...
      <div className="w-full flex flex-col items-start justify-center gap-[10px] text-base">
